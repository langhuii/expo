...
const STORY_API = 'http://124.50.249.203:8080/api/stories';
const STORY_UPLOAD_API = 'http://124.50.249.203:8080/api/story-files/upload';
...
export const uploadImage = async (uri) => {
  ...
  const fullUrl = `http://124.50.249.203:8080${relativeUrl}`;
  return fullUrl;
};
