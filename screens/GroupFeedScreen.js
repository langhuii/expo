...
import { View, Text, FlatList, Image, TouchableOpacity, Modal, TextInput, StyleSheet, Dimensions, Alert } from 'react-native';
...
const GroupFeedScreen = ({ route }) => {
  const { group } = route.params; // 전달받은 group 데이터 받기
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <Text style={styles.navTitle}>{group.name}</Text> {/* 그룹 이름 표시 */}
        <View style={{ width: 30 }} />
        <TouchableOpacity
